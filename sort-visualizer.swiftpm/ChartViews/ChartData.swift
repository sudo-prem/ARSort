...
struct ChartData {
    ...
    static var NSquareChartData: [ChartPoints] {
        ...
        for i in 0..<11 {
            points.append(.init(size: i, time: curr*curr))
            curr = curr + 1
        }
    ...
    static var NChartData: [ChartPoints] {
        ...
        for i in 0..<28 {
            points.append(.init(size: i, time: curr))
            curr = curr + 1
        }
    ...
    static var NLogNChartData: [ChartPoints] {
        ...
        for i in 0..<28 {
            points.append(.init(size: i, time: curr * log10(curr)))
            curr = curr + 1
        }
    ...
    static var ConstantChartData: [ChartPoints] {
        ...
        for i in 0..<28 {
            points.append(.init(size: i, time: 7.0))
        }
